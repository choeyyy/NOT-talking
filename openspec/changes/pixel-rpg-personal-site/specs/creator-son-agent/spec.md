...
The Son MUST NOT wake dormant **gnome** agents. Tall Folk ops are already always-on and are not "woken" by the Son.
...
- **THEN** gnome agents remain dormant until the Creator opens the Gnome Guild chat panel
